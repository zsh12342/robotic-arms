...
def main():
    ...
    parser.add_argument('--infer_tool', type=str, default='openvino', choices=("openvino", "onnxruntime"),
                        help='选择推理引擎')
    parser.add_argument('--ros_topic', type=str, default='/bottle_detection_node',
                        help='ROS topic to publish detection data')
        ...
        while not rospy.is_shutdown():
            ...
            for det in detections:
                ...
                if depth is not None:
                    detection_result = f"Class: bottle, Confidence: {conf:.2f}, Depth: {depth:.3f} meters"
