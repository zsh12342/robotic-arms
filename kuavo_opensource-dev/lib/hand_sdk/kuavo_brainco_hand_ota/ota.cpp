...
#ifdef __APPLE__
#define DEFAULT_SERIAL_PORT "/dev/tty.usbserial-14310"
#elif __linux__
...
void open_serial(const char* serial_port_name) {
    /* Open and configure port. */
    check(sp_get_port_by_name(serial_port_name, &port));
...
int main(int argc, char *argv[]) {
    ...
    stark_start_dfu(device, "./ota_bin/hand.ota");
