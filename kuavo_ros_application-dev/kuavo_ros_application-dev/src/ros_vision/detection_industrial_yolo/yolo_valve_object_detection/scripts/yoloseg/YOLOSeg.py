...
if __name__ == '__main__':
    ...
    if USE_SEGMENT_FLAG:
        ...
        model_path = "../models/yolo5s_forValve.onnx"

    # Initialize YOLOv7 object detector
    yoloseg = YOLOSeg(model_path, conf_thres=0.3, iou_thres=0.5)

    image_path = '/home/kuavo/kuavo_ros_application/src/ros_vision/detection_yolo/yolo_valve_object_detection/scripts/yoloseg/valve.jpg'
